...
@_coconut_tco
def compose(f, g):
    return _coconut_tail_call(_coconut_base_compose, f, (g, False))

mult5afterAdd10 = compose(_coconut.functools.partial(add, 10), _coconut.functools.partial(mult, 5))


(print)((mult5afterAdd10)(5))
